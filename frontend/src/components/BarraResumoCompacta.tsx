...
export function BarraResumoCompacta({ quantidadeItens, total, aoAbrir }: Props) {
  return (
    <button
      type="button"
      onClick={aoAbrir}
      className="fixed inset-x-0 bottom-0 z-40 flex items-center justify-between rounded-t-xl bg-primary px-4 py-3.5 text-primary-text shadow-[0_-4px_12px_rgba(0,0,0,0.15)] transition-colors hover:bg-primary-hover"
    >
