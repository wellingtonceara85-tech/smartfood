...
/**
 * Garante ADR-0022: usuarios só consome outro Bounded Context através da Application Service
 * Interface exportada (application/use-cases/*) — nunca domain/infrastructure/api internos de
 * outro módulo. Ver identidade-empresa/test/contract para o histórico da correção (Missão 0013).
 */
describe('Contrato — usuarios só consome outro Bounded Context via Use Case exportado', () => {
